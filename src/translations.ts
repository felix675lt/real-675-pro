...
export const translations: Record<Language, any> = {
  en: {
    ...
    reservation: {
      ...
      guestDesc: "Please provide your details for the reservation and communications.",
      name: "Full Name",
      email: "Email Address",
      phone: "Phone Number",
  ...
  ko: {
    ...
    reservation: {
      ...
      continue: "게스트 및 상세 정보 입력",
      detailsStep: "Step 03",
      guestInfo: "예약자 정보",
      guestDesc: "예약 확인 및 안내 수신을 위한 정보를 입력해주세요.",
      name: "성함",
      email: "이메일 주소",
      phone: "연락처",
  ...
  ja: {
    ...
    reservation: {
      ...
      detailsStep: "Step 03",
      guestInfo: "ゲスト情報",
      guestDesc: "予約の確認と連絡のために、あなたの情報を入力してください。",
      name: "フルネーム",
      email: "メールアドレス",
      phone: "電話番号",
  ...
  ru: {
    ...
    reservation: {
      ...
      continue: "К информации о госте",
      detailsStep: "Шаг 03",
      guestInfo: "Информация о госте",
      guestDesc: "Пожалуйста, предоставьте ваши данные для бронирования и связи.",
      name: "Полное Имя",
      email: "Электронная почта",
      phone: "Номер телефона",
      continuePayment: "К Оплате",
      step4: "Шаг 04",
